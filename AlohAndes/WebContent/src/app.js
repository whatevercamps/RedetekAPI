            ...
            if( $state.params.idCliente !== null ){
                ...
                $http.get(ruta).then(function (response) {
                    ...
                    $scope.modificarCliente = function () {
                        console.log($scope.data);
                        $http.put('http://localhost:8080/RedetekAPIRest/rest/clientes/' + $state.params.idCliente + '?idNodo=' + $scope.nodoX.idNodo, $scope.cliente, config).then(function (response) {
                            $state.go('verClientes', {}, {reload: true});
                        },
                        function(response){
                            console.log(response.data);
